...
class _$_CommentPageState implements _CommentPageState {
  _$_CommentPageState(
      {this.model = const [], required this.commentModel, this.loading = true});
  ...
  @override
  String toString() {
    return 'CommentPageState(model: $model, commentModel: $commentModel, loading: $loading)';
  }
...
abstract class _CommentPageState implements CommentPageState {
  factory _CommentPageState(
      {List<CommentGetModel> model,
      required CommentGetModel commentModel,
      bool loading}) = _$_CommentPageState;
